...
import co.app.bitcoinandroidtrackerapplication.R
import co.app.bitcoinandroidtrackerapplication.callbacks.OkCancelCallback
import co.app.bitcoinandroidtrackerapplication.constants.ApiConstants
import co.app.bitcoinandroidtrackerapplication.utilities.AppDetails
import co.app.bitcoinandroidtrackerapplication.utilities.AppDetails.Companion.context
import co.app.bitcoinandroidtrackerapplication.utilities.AppSharedPreferences
import co.app.bitcoinandroidtrackerapplication.view.appBase.MainActivity
...
class MainActivityPresenter(val mView: MainContractor.View) : MainContractor.Presenter {
    ...
    override fun onClick(
        ...
        if (showProgressBar!!) {
            ...
            //initAndShowProgressBar(AppDetails.activity!!)
        }
        ...
        when (caseConstants) {
            ApiConstants.currentprice -> {
                accessTokenCall = requestInterface.getcurrentprice()
                callApiWithAccessToken(accessTokenCall, context, ApiConstants.currentprice)
            }
        }
    }
